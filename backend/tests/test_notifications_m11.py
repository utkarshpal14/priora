...
from tests.conftest import create_auth_headers, create_auth_headers_with_user_id
...
def test_device_token_registration_and_unregistration(client: TestClient):
    ...
    """
    headers = create_auth_headers(client, email="device_user@priora.app", full_name="Device User")
...
def test_notification_preferences_get_and_update(client: TestClient):
    ...
    """
    headers = create_auth_headers(client, email="prefs_user@priora.app", full_name="Prefs User")
...
def test_notification_dispatcher_and_log_audit(client: TestClient, db_session: Session):
    ...
    """
    headers, user_id_str = create_auth_headers_with_user_id(client, email="dispatcher_audit@priora.app")
